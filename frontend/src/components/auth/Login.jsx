  ...
  return (
    <div className="flex flex-col justify-center items-center pt-10">
      <form
        ...
        className="flex flex-col justify-center px-8 py-5 rounded shadow shadow-slate-950 hover:shadow-gray-600 hover:shadow-md transition-all duration-300 ease-in-out transform md:w-2/4 w-2/3"
      >
        <h1 className="text-2xl font-bold mb-6 text-center">Login to SolKer</h1>
